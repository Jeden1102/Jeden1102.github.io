<template>
    <div class="flex p-8 flex-col bg-white sm:flex-row w-full items-start justify-center sm:justify-start ">
    ...
    <div v-for="skill in skillsList[searchedOption]"  class="flex w-full flex-col items-start ">
        <div v-if="!skill.title" class="flex w-full flex-col items-start pl-6 pt-1">
            <p v-if="skill.title" class="font-light text-left break-all">https://dominikraducki.works/fancyList/{{skill.name}}</p>
