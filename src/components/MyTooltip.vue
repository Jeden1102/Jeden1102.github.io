<template>
    <div class="w-3/4 h-3/4 text-lg absolute left-50 top-50 tootlip flex items-center justify-center bg-gray-100 text-black border border-black rounded-lg flex-col">
